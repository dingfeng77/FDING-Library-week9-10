...
const validateReason = (blur) => {
  if (formData.value.reason.length < 10) {
    if (blur) errors.value.reason = 'Reason must be as least 10 characters.'
  } else {
    errors.value.reason = null
  }
}

const validateReasonContainFriends = (blur) => {
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <textarea
              ...
              @input="() => {validateReason(false); validateReasonContainFriends(true)}"
